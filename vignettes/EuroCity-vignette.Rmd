...
![EuroCity shall I move app](.\vignettes\overview.png)
```{r}
knitr::include_graphics("./vignettes/overview.png")
```
...
![Sidebar of EuroCity shall I move app](.\vignettes\sidebar.png)
...
![Menu to choose quality of life criteria](\vignettes\plots_lifesatisfaction.png)


Next, select a criterion that you are interested in in the radio-button-menu below: 

![Menu to choose quality of life criteria](\vignettes\criteria_menu.png)

You will then see a bar plot comparing citizens' ratings of the chosen criterion for the respective cities: 

![Menu to choose quality of life criteria]("\vignettes\plot_QoL.png")
...
![Menu to choose quality of life criteria]("\vignettes\prices_menu.png")
...
![Menu to choose quality of life criteria]("\vignettes\plot_prices.png")
...
* `cities`: overview over the cities included in the package. This is mainly used for internal computations. 
